...
Use of {\bf bold text} and {\it italic text} is old-style.
Also {\em emphasised} and {\tt monospaced} should be updated.
...
%% ************************************************************
\section{Conclusion}
The method works well. Further work is needed. See Eq. 3 and Section 2 for details.
\end{document}
